...
test('MeshSlicePolygon#slice - cube-20mm.stl', function(t) {
...
test('MeshSlicePolygon#slice - cube-20mm-with-hole.stl', function(t) {
  testStl('cube-20mm-with-hole.stl', function(array, z) {

    t.equal(array.length, 2);
    t.equal(array[0].points.length, 4);
    t.equal(array[1].points.length, 4);
...
test('MeshSlicePolygon#slice - cube-bevel-8.stl', function(t) {
  testStl('cube-bevel-8.stl', function(array, z) {

    t.equal(array.length, 1);
    t.equal(array[0].points.length, 12);
...
test('cube-20mm-monohole.stl', function(t) {
  testStl('cube-20mm-monohole.stl', function(array, z) {
    ...
    t.equal(array.length, expect.length);
...
test('MeshSlicePolygon#slice - cube-30mm-concave-filletEdge-squareCut2-roundHole-squareHole.stl', function(t) {
  testStl('cube-30mm-concave-filletEdge-squareCut2-roundHole-squareHole.stl', function(array, z) {
    ...
    array.forEach(function(poly, idx) {
      t.ok(expect[idx]);
      t.equal(expect[idx].length, poly.points.length);
      allEqual(expect[idx], poly.points);
    });
  }, t);
});

test('pyramid-20mm.stl', function(t) {
